...
export default ({color, residence, email, profession, tel, born}) => {
  return (
    <div>
    <p>
        <i className={`fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-${color}`}></i>{profession}</p>
        <p><i className={`fa fa-star fa-fw w3-margin-right w3-large w3-text-${color}`}></i>{born}</p>
